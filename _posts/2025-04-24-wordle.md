...
@media (max-width: 720px) {
  ...
  .wordle-overlay__inner { padding: 12px 10px 8px; min-height: 100dvh; height: 100dvh; border-radius: 0; }
  .wordle-play-header { align-items: flex-start; margin: 0.3rem 0 0.4rem; }
